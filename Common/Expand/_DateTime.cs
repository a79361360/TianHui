...
namespace Fgly.Common.Expand
{
    public static class _DateTime
    {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static long TimeToUnixTimeStamp(this System.DateTime dt)
        {
            DateTime dtStart = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1));
            return (long)dt.Subtract(dtStart).TotalSeconds;
        }
        public static string ShowDiffTime(this System.DateTime dt)
        {
